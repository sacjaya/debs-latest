...
public class ManagerWithFileWriteThread_Handler_3 {
    ...
    public static void main(String[] args) {
        ...
        ManagerWithFileWriteThread_Handler_3 manager = new ManagerWithFileWriteThread_Handler_3();
    ...
    public ManagerWithFileWriteThread_Handler_3(){
